...
public class LeilaoTeste {
	...
	public void naoDeveAceitarMaisDeCincoLancesDoMesmoUsuario() {
		...
		leilao.propoe(new Lance(steveWozniak, 5000));
		leilao.propoe(new Lance(steveJobs, 6000));
		leilao.propoe(new Lance(steveWozniak, 7000));
		leilao.propoe(new Lance(steveJobs, 8000));
		leilao.propoe(new Lance(steveWozniak, 9000));
		leilao.propoe(new Lance(steveJobs, 10000));
		leilao.propoe(new Lance(steveWozniak,11000));
